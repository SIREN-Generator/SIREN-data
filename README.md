...
MARLEY v2.0.0 current and backwards-compatible v1 reaction, CRPA response,
mass, spin-parity, charge-radius, nuclear-structure, and logger inputs used by
SIREN's `MarleyCrossSection-v1.0` and `MarleyCrossSection-v2.0` resources. The
files are distributed as one
